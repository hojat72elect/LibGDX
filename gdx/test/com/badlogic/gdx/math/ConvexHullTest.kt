...
class ConvexHullTest {
    ...
    private fun assertArraySimilar(array: FloatArray, witness: kotlin.FloatArray, witnessOffset: Int, witnessCount: Int) {
        ...
        assertEquals((witnessCount + 2).toLong(), array.size.toLong())
