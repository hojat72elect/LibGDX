...
public interface GL32 extends GL31 {
    ...
    void glDebugMessageControl(int source, int type, int severity, java.nio.IntBuffer ids, boolean enabled);
    ...
    void glGetnUniformfv(int program, int location, java.nio.FloatBuffer params);

    void glGetnUniformiv(int program, int location, java.nio.IntBuffer params);

    void glGetnUniformuiv(int program, int location, java.nio.IntBuffer params);
