 ...
 * [.canRender] method can be used to check if the Shader instance can be used for a specific
 * [Renderable]. Rendering a [Renderable] using a Shader for which [.canRender] returns false might
...
interface Shader : Disposable {
     ...
     * There's a possibility that the other shader is null (in general it shouldn't be).
     */
    fun compareTo(other: Shader?): Int // TODO: probably better to add some weight value to sort on
