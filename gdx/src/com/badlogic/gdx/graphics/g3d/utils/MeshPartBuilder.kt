...
interface MeshPartBuilder {
    ...
    /**
     * @return The primitive type used for building, e.g. [com.badlogic.gdx.graphics.GL20.GL_TRIANGLES] or [com.badlogic.gdx.graphics.GL20.GL_LINES].
     */
    fun getPrimitiveType(): Int
     ...
     */
    fun isVertexTransformationEnabled(): Boolean

    /**
     * Sets whether vertex transformation is enabled.
     */
    fun setVertexTransformationEnabled(enabled: Boolean)
    ...
    /**
     * Add a vertex, returns the index. Null values are allowed. Use [.getAttributes] to check which values are
     * available.
     */
    ...
    class VertexInfo : Poolable {
        ...
        fun set(pos: Vector3?, nor: Vector3?, col: Color?, uv: Vector2?): VertexInfo {
            reset()
