...
interface Vector<T : Vector<T>> {
    ...
    /**
     * @return true if this vector is collinear with the other vector ([.isOnLine] && [.hasSameDirection]).
     */
    ...
    /**
     * @return true if this vector is opposite collinear with the other vector ([.isOnLine] && [.hasOppositeDirection]).
     */
