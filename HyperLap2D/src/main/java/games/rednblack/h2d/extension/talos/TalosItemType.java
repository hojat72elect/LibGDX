...
public class TalosItemType implements IExternalItemType {
    ...
    private final DrawableLogic drawableLogic;
    private ResourceRetrieverAssetProvider assetProvider;
    private FileHandle talosToLoad;
    private final ObjectMap<String, ShaderDescriptor> shaderDescriptorObjectMap = new ObjectMap<>();
    private final ObjectMap<String, VectorField> vectorFieldDescriptorObjectMap = new ObjectMap<>();
