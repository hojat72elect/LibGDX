...
public class ImageTabbedPane {
    ...
    private final VisImageButton.VisImageButtonStyle sharedCloseActiveButtonStyle;

    private final DragPane tabsPane;
    private final TabbedPaneTable mainTable;

    private final Array<ImageTab> tabs;
    private final IdentityMap<ImageTab, TabButtonTable> tabsButtonMap;
    private final ButtonGroup<Button> group;

    private ImageTab activeTab;

    private final Array<ImageTabbedPaneListener> listeners;
    ...
    private class TabButtonTable extends VisTable {
        ...
        private final Cell<Button> cellButton;
