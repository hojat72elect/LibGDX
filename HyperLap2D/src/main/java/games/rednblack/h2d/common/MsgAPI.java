...
public class MsgAPI {
    ...
    public static final String ACTION_CHANGE_LIBRARY_ACTION = SANDBOX_PREFIX + ".ACTION_CHANGE_LIBRARY_ACTION";
    ...
    public static final String ACTION_UPDATE_CIRCLE_SHAPE = SANDBOX_PREFIX + ".ACTION_UPDATE_CIRCLE_SHAPE";
    ...
    public static final String ACTION_UPDATE_POLYGON_DATA = SANDBOX_PREFIX + ".ACTION_UPDATE_POLYGON_DATA";
    ...
    // drop down resources
    public static final String ACTION_DELETE_MULTIPLE_RESOURCE = SANDBOX_PREFIX + ".ACTION_DELETE_MULTIPLE_RESOURCE";
    public static final String ACTION_DELETE_IMAGE_RESOURCE = SANDBOX_PREFIX + ".ACTION_DELETE_IMAGE_RESOURCE";
    public static final String ACTION_DELETE_TINY_VG_RESOURCE = SANDBOX_PREFIX + ".ACTION_DELETE_TINY_VG_RESOURCE";
    public static final String ACTION_DELETE_SHADER = SANDBOX_PREFIX + ".ACTION_DELETE_SHADER";
    ...
    public static final String ACTION_RENAME_ACTION_ITEM = SANDBOX_PREFIX + ".ACTION_RENAME_ACTION_ITEM";
    ...
    public static final String ACTION_CENTER_ORIGIN_POSITION = SANDBOX_PREFIX + ".ACTION_CENTER_ORIGIN_POSITION";
    /**
     * Other
     */
