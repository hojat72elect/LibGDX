...
import games.rednblack.editor.renderer.data.CoreActorData;
...
public class CompositeActor extends Group {
    ...
    private final float pixelsPerWU;
    private final float resMultiplier;
    private final Array<IActorScript> scripts = new Array<IActorScript>(3);
    private final HashMap<Integer, Actor> indexes = new HashMap<Integer, Actor>();
    private final HashMap<String, LayerItemVO> layerMap = new HashMap<String, LayerItemVO>();
    ...
    protected void processMain(Actor actor, MainItemVO vo) {
        ...
        actor.setVisible(layerMap.get(vo.layerName).isVisible);
    }
