...
public class UIPhysicsProperties extends UIRemovableProperties {
    ...
    public VisValidatableTextField getAngularDampingField() {
        return angularDumpingField;
    }
    ...
    public VisCheckBox getSensorBox() {
        return sensor;
    }

    public VisCheckBox getFineBoundBox() {
        return fineBoundBox;
    }

    public VisCheckBox getFixedRotationBox() {
