...
public class UILightItemProperties extends UIItemCollapsibleProperties {
    ...
    private final VisCheckBox isStaticCheckBox;
    private final VisCheckBox isXRayCheckBox;
    private final Spinner rayCountSelector;

    private final VisValidatableTextField pointLightRadiusField;
    private final VisValidatableTextField coneInnerAngleField;
    private final VisValidatableTextField heightField;
    private final VisValidatableTextField intensityField;
    private final VisValidatableTextField constantFalloffField;
    private final VisValidatableTextField linearFalloffField;
    private final VisValidatableTextField quadraticFalloffField;
    private final VisValidatableTextField coneDistanceField;
    private final VisValidatableTextField coneDirectionField;
    private final VisValidatableTextField softnessLengthField;
    private final VisCheckBox isActiveCheckBox;
    private final VisCheckBox isSoftCheckBox;

    private final VisLabel lightTypeLabel;

    private final VisTable secondaryTable;
