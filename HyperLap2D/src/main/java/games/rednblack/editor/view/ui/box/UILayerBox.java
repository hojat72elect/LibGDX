...
public class UILayerBox extends UICollapsibleBox {
    ...
    private final VisTable bottomPane;
    private final VisScrollPane scrollPane;
    private final VisTable layersTable;

    private SlotSource sourceInEdition;

    private final Array<UILayerItemSlot> rows = new Array<>();
    ...
    public class UILayerItem extends VisTable {
        ...
        private final VisTextField layerNameField;
