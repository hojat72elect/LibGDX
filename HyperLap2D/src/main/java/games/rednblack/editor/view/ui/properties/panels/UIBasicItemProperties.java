...
public class UIBasicItemProperties extends UIItemProperties {
    ...
    private final Image itemTypeIcon;
    private final VisLabel itemType;

    private final VisImageButton linkImage;
    private final VisImageButton linkScaleButton;
    private final VisLabel libraryLinkLabel;

    private final VisTable linkageContainer;

    private final VisTextField idBox;

    private final VisTextField xValue;
    private final VisTextField yValue;
    private final VisTextField widthValue;
    private final VisTextField heightValue;
    private final VisTextField scaleXValue;
    private final VisTextField scaleYValue;
    private final VisCheckBox flipY;
    private final VisCheckBox flipX;
    private final TintButton tintColorComponent;
    private final VisTextField rotationValue;
    private final VisTextButton customVarsButton;
    private final VisTextButton tagsButton;

    private final VisSelectBox<String> nonExistantComponents;
    private final VisTextButton addComponentButton;
    ...
    private final class LinkedScaleChangeListener extends ChangeListener {
        ...
        public void changed(ChangeEvent event, Actor actor) {
            if (isXYScaleLinked() && actor instanceof VisTextField field) {
