...
public class UILabelItemProperties extends UIItemCollapsibleProperties {
    ...
    private final HashMap<Integer, String> alignMap = new HashMap<>();
    private final Array<String> alignNames = new Array<>();

    private final Facade facade;

    private final VisSelectBox<String> fontFamilySelectBox;
    private final VisSelectBox<String> bitmapFontSelectBox;
    private final VisSelectBox<String> alignSelectBox;
    private final VisCheckBox boldCheckBox;
    private final VisCheckBox wrapCheckBox;
    private final VisCheckBox monoCheckBox;
    private final VisCheckBox italicCheckBox;
    private final Spinner fontSizeField;
