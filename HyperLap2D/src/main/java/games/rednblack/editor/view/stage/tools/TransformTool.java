...
import games.rednblack.editor.view.stage.tools.transformStrategy.BasicStrategy;
import games.rednblack.editor.view.stage.tools.transformStrategy.CompositeStrategy;
import games.rednblack.editor.view.stage.tools.transformStrategy.ITransformStrategy;
import games.rednblack.editor.view.stage.tools.transformStrategy.LabelStrategy;
import games.rednblack.editor.view.stage.tools.transformStrategy.NinePatchStrategy;
...
public class TransformTool extends SelectionTool implements FollowerTransformationListener {
    ...
    private final TransformCommandBuilder commandBuilder = new TransformCommandBuilder();
    ...
    private CursorData getCursorForAngle(float angle, boolean isRotation) {
        ...
        if (isRotation) {
            ...
            switch (sector) {
                ...
                case 1:
                    return Cursors.ROTATION_RT; // North-East
                case 2: // Top
                case 3:
                    return Cursors.ROTATION_LT; // North-West
                case 4: // Left
                case 5:
                    return Cursors.ROTATION_LB; // South-West
                case 6: // Bottom
                case 7:
                    return Cursors.ROTATION_RB; // South-East
                default:
                    return Cursors.ROTATION_RB;
            }
        } else {
            // Mapping for resizing cursors (arrows)
            switch (sector) {
                case 0:
                    return Cursors.TRANSFORM_HORIZONTAL; // 0 degrees (Right)
                case 1:
                    return Cursors.TRANSFORM_LEFT_RIGHT; // 45 degrees (Top-Right / Bottom-Left) [ / ]
                case 2:
                    return Cursors.TRANSFORM_VERTICAL;   // 90 degrees (Top)
                case 3:
                    return Cursors.TRANSFORM_RIGHT_LEFT; // 135 degrees (Top-Left / Bottom-Right) [ \ ]
                case 4:
                    return Cursors.TRANSFORM_HORIZONTAL; // 180 degrees (Left)
                case 5:
                    return Cursors.TRANSFORM_LEFT_RIGHT; // 225 degrees [ / ]
                case 6:
                    return Cursors.TRANSFORM_VERTICAL;   // 270 degrees (Bottom)
                case 7:
                    return Cursors.TRANSFORM_RIGHT_LEFT; // 315 degrees [ \ ]
                default:
