...
public class BoxItemResourceSelectionUIMediator extends Mediator<BoxItemResource> {
     ...
     */
    private final ObjectSet<VisTable> boxesTableSet = new ObjectSet<>();
    ...
    private void handleShiftClick(BoxItemResource boxResource) {
        ...
        setSelectionBetween(boxResourcePreviousClick, boxResource, !removed);
    }
    ...
    private void handleShiftCtrlClick(BoxItemResource boxResource) {
        ...
        setSelectionBetween(boxResourcePreviousClick, boxResource, !boxResourceSelectedSet.remove(boxResource.getPayloadData().name));
    }
    ...
    private void handleCtrlClick(BoxItemResource boxResource) {
        ...
        setSelected(boxResource, !boxResourceSelectedSet.remove(boxResource.getPayloadData().name));
    }
