...
import games.rednblack.editor.graph.GraphChangedListener;
...
import games.rednblack.editor.graph.actions.config.AlphaActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.ColorActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.DelayActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.EntityNodeConfiguration;
import games.rednblack.editor.graph.actions.config.EventActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.FadeInActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.FadeOutActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.ForeverActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.MoveByActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.MoveToActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.ParallelActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.RepeatActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.RotateByActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.RotateToActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.ScaleByActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.ScaleToActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.SequenceActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.SizeByActionNodeConfiguration;
import games.rednblack.editor.graph.actions.config.SizeToActionNodeConfiguration;
...
import games.rednblack.editor.graph.actions.config.value.ValueInterpolationNodeConfiguration;
import games.rednblack.editor.graph.actions.config.value.ValueParamNodeConfiguration;
import games.rednblack.editor.graph.actions.config.value.ValueVector2NodeConfiguration;
...
import games.rednblack.editor.graph.producer.value.ValueParamBoxProducer;
...
public class NodeEditorDialog extends H2DDialog implements Graph<GraphBox<ActionFieldType>, GraphConnection, PropertyBox<ActionFieldType>, ActionFieldType> {
    ...
    private final GraphValidator<GraphBox<ActionFieldType>, GraphConnection, PropertyBox<ActionFieldType>, ActionFieldType> graphValidator = new GraphValidator<>();
