...
public class UISpriteAnimationItemProperties extends UIItemCollapsibleProperties {
    ...
    private final Spinner fpsSelector;
    private final VisSelectBox<String> animationsSelectBox;
    private final VisSelectBox<String> playModesSelectBox;
    private final VisTextButton editAnimationsButton;
    private final Array<String> playModeNames = new Array<>();
