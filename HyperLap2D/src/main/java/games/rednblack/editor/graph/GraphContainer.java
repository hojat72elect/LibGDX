...
public class GraphContainer<T extends FieldType> extends Table implements NavigableCanvas {
    ...
    private final Map<String, GraphBox<T>> graphBoxes = new HashMap<>();
    private final Map<String, VisWindow> boxWindows = new HashMap<>();
    private final Map<VisWindow, Vector2> windowPositions = new HashMap<>();
    private final List<GraphConnection> graphConnections = new LinkedList<>();
    private final Map<NodeConnector, Shape> connectionNodeMap = new HashMap<>();
    private final Map<GraphConnection, Shape> connections = new HashMap<>();
    private final Map<NodeGroupImpl, Rectangle> nodeGroups = new HashMap<>();
    ...
    private final NodeConnector tmpNodeInfo1 = new NodeConnector();
    private final NodeConnector tmpNodeInfo2 = new NodeConnector();
