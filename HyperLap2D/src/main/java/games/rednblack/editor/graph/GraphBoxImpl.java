...
public class GraphBoxImpl<T extends FieldType> implements GraphBox<T> {
    ...
    private final NodeConfiguration<T> configuration;
    private final Table table;
    private final Table headerTable;
    private final Table partTable;
    private final Table footerTable;
    private final List<GraphBoxPart<T>> graphBoxParts = new LinkedList<>();
    private final Map<String, GraphBoxInputConnector<T>> inputConnectors = new HashMap<>();
    private final Map<String, GraphBoxOutputConnector<T>> outputConnectors = new HashMap<>();
