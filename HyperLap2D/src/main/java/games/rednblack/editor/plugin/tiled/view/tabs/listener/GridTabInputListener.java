...
public class GridTabInputListener<T extends TextureRegionVO> extends InputListener {
    ...
    private final AbstractGridTilesTab<T> tab;
    private final String tileSelectedNotification;
    private final String openDropDownNotification;

    private final TiledPlugin tiledPlugin;

    private final VisTable table;

    private final Array<VisImageButton> tiles;

    private boolean isDragging = false;
    private Actor draggingSource;

    private final Array<T> savedTiles;
