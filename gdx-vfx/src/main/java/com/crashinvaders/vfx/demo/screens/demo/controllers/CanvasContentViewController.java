...
public class CanvasContentViewController extends LmlViewController {
    ...
    @LmlAction("transformVfxCanvas")
    void transformVfxCanvas() {
    ...
    @LmlAction("onMatchWidgetSizeChanged")
    void onMatchWidgetSizeChanged(CheckBox checkBox) {
        boolean checked = checkBox.isChecked();
        vfxGroup.setMatchWidgetSize(checked);
    }

    @LmlAction("onTransparentBackgroundChanged")
    void onTransparentBackgroundChanged(CheckBox checkBox) {
        boolean checked = checkBox.isChecked();
