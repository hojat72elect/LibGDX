...
public class VerticalGradientDrawable extends BaseDrawable {
    ...
    public VerticalGradientDrawable(TextureRegion region) {
        ...
        vertices[0 + COMP_U] = region.getU();
        vertices[0 + COMP_V] = region.getV();
        vertices[VERT_SIZE + COMP_U] = region.getU();
        vertices[VERT_SIZE + COMP_V] = region.getV2();
    ...
    public VerticalGradientDrawable setColors(Color colorBottom, Color colorTop) {
        ...
        vertices[0 + COMP_COLOR] = colorBitsBottom;
        vertices[VERT_SIZE + COMP_COLOR] = colorBitsTop;
    ...
    public void draw(Batch batch, float x, float y, float width, float height) {
        ...
        vertices[0 + COMP_X] = x;
        vertices[0 + COMP_Y] = y;
        vertices[VERT_SIZE + COMP_X] = x;
        vertices[VERT_SIZE + COMP_Y] = fy2;
