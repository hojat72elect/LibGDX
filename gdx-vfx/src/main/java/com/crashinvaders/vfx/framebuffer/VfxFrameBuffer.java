 ...
 * You can use multiple instances of this class to draw into one frame buffer
 * while you drawing into another one,
 ...
 * </pre>
 * <p>
 * {@link VfxFrameBuffer} internally switches GL viewport between
 * {@link #begin()} and {@link #end()}.
 * <br>
 * If you use any kind of batch renders (e.g. {@link Batch} or
 * {@link ShapeRenderer}),
 * you should update their transform and projection matrices to setup viewport
 * to the target frame buffer's size.
 * You can do so by registering {@link Renderer} using
 * {@link #addRenderer(Renderer)} and {@link #removeRenderer(Renderer)}.
 * The registered renderers will automatically switch their matrices back and
 * forth respectively upon {@link #begin()} and {@link #end()} calls.
...
public class VfxFrameBuffer implements Disposable {
    ...
    /**
     * Current depth of buffer nesting rendering (keeps track of how many buffers
    ...
    public void end() {
        ...
        Gdx.gl20.glViewport(preservedViewport.x, preservedViewport.y, preservedViewport.width,
                preservedViewport.height);
    ...
    public static abstract class RendererAdapter implements Renderer {
        private final Matrix4 preservedProjection = createMatrix();
        private final Matrix4 preservedTransform = createMatrix();
