...
class PatchedOnClickLmlAttributeTest {

    private lateinit var attribute: PatchedOnClickLmlAttribute
    ...
    @Before
    fun setUp() {
        attribute = PatchedOnClickLmlAttribute()
