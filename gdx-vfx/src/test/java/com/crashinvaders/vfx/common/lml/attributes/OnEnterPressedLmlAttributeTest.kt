...
class OnEnterPressedLmlAttributeTest {

    private lateinit var attribute: OnEnterPressedLmlAttribute
    ...
    @Before
    fun setUp() {
        attribute = OnEnterPressedLmlAttribute()
    ...
    fun `process adds input listener correctly`() {
        ...
        // Test ENTER key
        listener.keyDown(event, Input.Keys.ENTER)
