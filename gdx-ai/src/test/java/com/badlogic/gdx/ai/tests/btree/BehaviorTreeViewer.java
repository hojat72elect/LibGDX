...
public class BehaviorTreeViewer<E> extends Table {
    ...
    private final ObjectMap<Task<E>, TaskNode> taskNodes;
    private int step;
    private final Label stepLabel;
    private final Slider runDelaySlider;
    private final TextButton runButton;
    private final TextButton stepButton;
    ...
    private void updateStepLabel() {
        StringBuilder sb = new StringBuilder(stepLabel.getText());
    ...
    private static class TaskNode extends Tree.Node {
        ...
        private static class View extends Table {
            ...
            private static final DistributionAdapters DAs = new DistributionAdapters();
            Label name;
            Label status;
            TaskNode taskNode;
