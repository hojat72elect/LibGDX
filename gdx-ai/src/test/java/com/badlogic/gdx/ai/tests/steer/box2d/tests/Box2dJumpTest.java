...
// character.body.setAnisotropicFriction(new Vector3(0,0,0)); // ???
        ...
        JumpCallback jumpCallback = new JumpCallback() {
            final JumpDescriptor<Vector2> newJumpDescriptor = new JumpDescriptor<Vector2>(new Vector2(), new Vector2());
        ...
        seekSB = new Seek<Vector2>(character, new SteerableAdapter<Vector2>() {
            final Vector2 pos = new Vector2(jumpDescriptor.landingPosition).add(1000, 0);
