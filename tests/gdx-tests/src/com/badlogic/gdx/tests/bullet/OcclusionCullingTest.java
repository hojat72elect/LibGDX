...
public class OcclusionCullingTest extends BaseBulletTest {
    ...
    public void create() {
        ...
        String sb = "Swipe for next test\n" +
                "Long press to toggle debug mode\n" +
                "Ctrl+drag to rotate\n" +
                "Scroll to zoom\n" +
                "Tap to spawn dynamic entity, press\n" +
                "'0' to spawn " + KEY_SPAWN_OCCLUDEE_AMOUNT + " static entities\n" +
                "'1' to set normal/disabled/occlusion-culling\n" +
                "'2' to change camera\n" +
                "'3' to toggle camera movement\n" +
                "'4' to cycle occlusion buffer sizes\n" +
                "'5' to toggle occlusion buffer image\n" +
                "'6' to toggle shadows\n";
        instructions = sb;
