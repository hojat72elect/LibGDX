...
public class TiledMapGWTAtlasAssetManagerTest extends GdxTest {
    ...
    private final String fileName = "data/maps/tiled-atlas-processed/test_gwt_uncompressed.tmx";
    private final String fileNameWithImageLayers = "data/maps/tiled-atlas-processed/test_w_imglayers_gwt_uncompressed.tmx";
    private final String fileNameWithCollectionImages = "data/maps/tiled-atlas-processed/test_w_imglayers_coi_gwt_uncompressed.tmx";
