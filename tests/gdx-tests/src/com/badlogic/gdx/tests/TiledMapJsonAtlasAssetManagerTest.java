...
public class TiledMapJsonAtlasAssetManagerTest extends GdxTest {
    ...
    private final String fileName = "data/maps/tiled-atlas-processed/test.tmj";
    // This Map also must include a tiled properties file
    private final String fileNameWithImageLayersAndProps = "data/maps/tiled-atlas-processed/test_w_imglayer_props.tmj";
    private final String projectFilePath = "data/maps/tiled-atlas-processed/tiled-prop-test.tiled-project";
