...
public class EntityTests {
    ...
    private final ComponentMapper<ComponentA> am = ComponentMapper.getFor(ComponentA.class);
    private final ComponentMapper<ComponentB> bm = ComponentMapper.getFor(ComponentB.class);
