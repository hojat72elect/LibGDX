...
class EntityManager {
    ...
    private final ObjectSet<Entity> entitySet = new ObjectSet<Entity>();
    private final ImmutableArray<Entity> immutableEntities = new ImmutableArray<Entity>(entities);
    private final Array<EntityOperation> pendingOperations = new Array<EntityOperation>(false, 16);
