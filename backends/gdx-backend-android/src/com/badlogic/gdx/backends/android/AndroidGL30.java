...
public class AndroidGL30 extends AndroidGL20 implements GL30 {
    ...
    @Override
    public void glDrawRangeElements(int mode, int start, int end, int count, int type, @NotNull java.nio.Buffer indices) {
    ...
    public void glTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth,
                                int format, int type, @NotNull java.nio.Buffer pixels) {
    ...
    @Override
    public void glGenQueries(int n, @NotNull int[] ids, int offset) {
        GLES30.glGenQueries(n, ids, offset);
    }

    @Override
    public void glGenQueries(int n, @NotNull java.nio.IntBuffer ids) {
        GLES30.glGenQueries(n, ids);
    }

    @Override
    public void glDeleteQueries(int n, @NotNull int[] ids, int offset) {
        GLES30.glDeleteQueries(n, ids, offset);
    }

    @Override
    public void glDeleteQueries(int n, @NotNull java.nio.IntBuffer ids) {
    ...
    @Override
    public void glGetQueryiv(int target, int pname, @NotNull java.nio.IntBuffer params) {
        GLES30.glGetQueryiv(target, pname, params);
    }

    @Override
    public void glGetQueryObjectuiv(int id, int pname, @NotNull java.nio.IntBuffer params) {
    ...
    @Override
    public void glDrawBuffers(int n, @NotNull java.nio.IntBuffer bufs) {
        GLES30.glDrawBuffers(n, bufs);
    }

    @Override
    public void glUniformMatrix2x3fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
        GLES30.glUniformMatrix2x3fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix3x2fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
        GLES30.glUniformMatrix3x2fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix2x4fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
        GLES30.glUniformMatrix2x4fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix4x2fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
        GLES30.glUniformMatrix4x2fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix3x4fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
        GLES30.glUniformMatrix3x4fv(location, count, transpose, value);
    }

    @Override
    public void glUniformMatrix4x3fv(int location, int count, boolean transpose, @NotNull java.nio.FloatBuffer value) {
    ...
    @Override
    public void glDeleteVertexArrays(int n, @NotNull int[] arrays, int offset) {
        GLES30.glDeleteVertexArrays(n, arrays, offset);
    }

    @Override
    public void glDeleteVertexArrays(int n, @NotNull java.nio.IntBuffer arrays) {
        GLES30.glDeleteVertexArrays(n, arrays);
    }

    @Override
    public void glGenVertexArrays(int n, @NotNull int[] arrays, int offset) {
        GLES30.glGenVertexArrays(n, arrays, offset);
    }

    @Override
    public void glGenVertexArrays(int n, @NotNull java.nio.IntBuffer arrays) {
    ...
    @Override
    public void glTransformFeedbackVaryings(int program, @NotNull String[] varyings, int bufferMode) {
    ...
    @Override
    public void glGetVertexAttribIiv(int index, int pname, @NotNull java.nio.IntBuffer params) {
        GLES30.glGetVertexAttribIiv(index, pname, params);
    }

    @Override
    public void glGetVertexAttribIuiv(int index, int pname, @NotNull java.nio.IntBuffer params) {
    ...
    @Override
    public void glGetUniformuiv(int program, int location, @NotNull java.nio.IntBuffer params) {
        GLES30.glGetUniformuiv(program, location, params);
    }

    @Override
    public int glGetFragDataLocation(int program, @NotNull String name) {
        return GLES30.glGetFragDataLocation(program, name);
    }

    @Override
    public void glUniform1uiv(int location, int count, @NotNull java.nio.IntBuffer value) {
        GLES30.glUniform1uiv(location, count, value);
    }

    @Override
    public void glUniform3uiv(int location, int count, @NotNull java.nio.IntBuffer value) {
        GLES30.glUniform3uiv(location, count, value);
    }

    @Override
    public void glUniform4uiv(int location, int count, @NotNull java.nio.IntBuffer value) {
        GLES30.glUniform4uiv(location, count, value);
    }

    @Override
    public void glClearBufferiv(int buffer, int drawbuffer, @NotNull java.nio.IntBuffer value) {
        GLES30.glClearBufferiv(buffer, drawbuffer, value);
    }

    @Override
    public void glClearBufferuiv(int buffer, int drawbuffer, @NotNull java.nio.IntBuffer value) {
        GLES30.glClearBufferuiv(buffer, drawbuffer, value);
    }

    @Override
    public void glClearBufferfv(int buffer, int drawbuffer, @NotNull java.nio.FloatBuffer value) {
    ...
    @Override
    public void glGetUniformIndices(int program, @NotNull String[] uniformNames, @NotNull java.nio.IntBuffer uniformIndices) {
        GLES30.glGetUniformIndices(program, uniformNames, uniformIndices);
    }

    @Override
    public void glGetActiveUniformsiv(int program, int uniformCount, @NotNull java.nio.IntBuffer uniformIndices, int pname,
                                      @NotNull java.nio.IntBuffer params) {
        GLES30.glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params);
    }

    @Override
    public int glGetUniformBlockIndex(int program, @NotNull String uniformBlockName) {
        return GLES30.glGetUniformBlockIndex(program, uniformBlockName);
    }

    @Override
    public void glGetActiveUniformBlockiv(int program, int uniformBlockIndex, int pname, @NotNull java.nio.IntBuffer params) {
        GLES30.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
    }

    @Override
    public void glGetActiveUniformBlockName(int program, int uniformBlockIndex, @NotNull java.nio.Buffer length,
                                            @NotNull java.nio.Buffer uniformBlockName) {
    ...
    @Override
    public void glGetInteger64v(int pname, @NotNull java.nio.LongBuffer params) {
        GLES30.glGetInteger64v(pname, params);
    }

    @Override
    public void glGetBufferParameteri64v(int target, int pname, @NotNull java.nio.LongBuffer params) {
        GLES30.glGetBufferParameteri64v(target, pname, params);
    }

    @Override
    public void glGenSamplers(int count, @NotNull int[] samplers, int offset) {
        GLES30.glGenSamplers(count, samplers, offset);
    }

    @Override
    public void glGenSamplers(int count, @NotNull java.nio.IntBuffer samplers) {
        GLES30.glGenSamplers(count, samplers);
    }

    @Override
    public void glDeleteSamplers(int count, @NotNull int[] samplers, int offset) {
        GLES30.glDeleteSamplers(count, samplers, offset);
    }

    @Override
    public void glDeleteSamplers(int count, @NotNull java.nio.IntBuffer samplers) {
    ...
    @Override
    public void glSamplerParameteriv(int sampler, int pname, @NotNull java.nio.IntBuffer param) {
    ...
    @Override
    public void glSamplerParameterfv(int sampler, int pname, @NotNull java.nio.FloatBuffer param) {
        GLES30.glSamplerParameterfv(sampler, pname, param);
    }

    @Override
    public void glGetSamplerParameteriv(int sampler, int pname, @NotNull java.nio.IntBuffer params) {
        GLES30.glGetSamplerParameteriv(sampler, pname, params);
    }

    @Override
    public void glGetSamplerParameterfv(int sampler, int pname, @NotNull java.nio.FloatBuffer params) {
    ...
    @Override
    public void glDeleteTransformFeedbacks(int n, @NotNull int[] ids, int offset) {
        GLES30.glDeleteTransformFeedbacks(n, ids, offset);
    }

    @Override
    public void glDeleteTransformFeedbacks(int n, @NotNull java.nio.IntBuffer ids) {
        GLES30.glDeleteTransformFeedbacks(n, ids);
    }

    @Override
    public void glGenTransformFeedbacks(int n, @NotNull int[] ids, int offset) {
        GLES30.glGenTransformFeedbacks(n, ids, offset);
    }

    @Override
    public void glGenTransformFeedbacks(int n, @NotNull java.nio.IntBuffer ids) {
    ...
    @Override
    public void glInvalidateFramebuffer(int target, int numAttachments, @NotNull java.nio.IntBuffer attachments) {
        GLES30.glInvalidateFramebuffer(target, numAttachments, attachments);
    }

    @Override
    public void glInvalidateSubFramebuffer(int target, int numAttachments, @NotNull java.nio.IntBuffer attachments, int x, int y,
